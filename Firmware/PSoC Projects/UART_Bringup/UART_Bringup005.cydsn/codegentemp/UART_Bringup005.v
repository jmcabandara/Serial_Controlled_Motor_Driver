// ======================================================================
// UART_Bringup005.v generated from TopDesign.cysch
// 06/21/2016 at 16:33
...
module top ;
	...
	wire [0:0] tmpOE__DEBUGPIN0_net;
	wire [0:0] tmpFB_0__DEBUGPIN0_net;
	wire [0:0] tmpIO_0__DEBUGPIN0_net;
	wire [0:0] tmpINTERRUPT_0__DEBUGPIN0_net;
	electrical [0:0] tmpSIOVREF__DEBUGPIN0_net;

	cy_psoc3_pins_v1_10
		#(.id("b7306af5-02f4-42b4-adcd-44802c2b23fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DEBUGPIN0
		 (.oe(tmpOE__DEBUGPIN0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DEBUGPIN0_net[0:0]}),
		  .io({tmpIO_0__DEBUGPIN0_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUGPIN0_net),
		  .interrupt({tmpINTERRUPT_0__DEBUGPIN0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUGPIN0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__DEBUGPIN1_net;
	wire [0:0] tmpFB_0__DEBUGPIN1_net;
	wire [0:0] tmpIO_0__DEBUGPIN1_net;
	wire [0:0] tmpINTERRUPT_0__DEBUGPIN1_net;
	electrical [0:0] tmpSIOVREF__DEBUGPIN1_net;

	cy_psoc3_pins_v1_10
		#(.id("1044d437-af60-46d2-99c1-5d42474b05ae"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DEBUGPIN1
		 (.oe(tmpOE__DEBUGPIN1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DEBUGPIN1_net[0:0]}),
		  .io({tmpIO_0__DEBUGPIN1_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUGPIN1_net),
		  .interrupt({tmpINTERRUPT_0__DEBUGPIN1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUGPIN1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__DEBUGPIN2_net;
	wire [0:0] tmpFB_0__DEBUGPIN2_net;
	wire [0:0] tmpIO_0__DEBUGPIN2_net;
	wire [0:0] tmpINTERRUPT_0__DEBUGPIN2_net;
	electrical [0:0] tmpSIOVREF__DEBUGPIN2_net;

	cy_psoc3_pins_v1_10
		#(.id("c7d657d3-23b9-4b2a-9452-e003c5b3f4ec"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DEBUGPIN2
		 (.oe(tmpOE__DEBUGPIN2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DEBUGPIN2_net[0:0]}),
		  .io({tmpIO_0__DEBUGPIN2_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUGPIN2_net),
		  .interrupt({tmpINTERRUPT_0__DEBUGPIN2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUGPIN2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DEBUGPIN3_net;
	wire [0:0] tmpFB_0__DEBUGPIN3_net;
	wire [0:0] tmpIO_0__DEBUGPIN3_net;
	wire [0:0] tmpINTERRUPT_0__DEBUGPIN3_net;
	electrical [0:0] tmpSIOVREF__DEBUGPIN3_net;

	cy_psoc3_pins_v1_10
		#(.id("4b1d1651-159e-4e80-aaa8-e73527e48ba1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DEBUGPIN3
		 (.oe(tmpOE__DEBUGPIN3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DEBUGPIN3_net[0:0]}),
		  .io({tmpIO_0__DEBUGPIN3_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUGPIN3_net),
		  .interrupt({tmpINTERRUPT_0__DEBUGPIN3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUGPIN3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
